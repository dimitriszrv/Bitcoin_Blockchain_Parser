...
class Input_Transactions:
    ...
    def read_input_txs(self):    
        ...
        print("\n### \t INPUT TRANSACTIONS \t ###")
        print("-------------------------------------")
        print("Previous Transaction ID (hex): ", self.previous_tx_id)
        print("Previous Transaction Out Index (hex): ", self.previous_tx_out_index)
        print("Script Length: ", self.script_length)
        print("Signature Script (hex): ", self.signature_script)

...
## About
As data is encrypted and stored on <a href="https://bitcoin.org/en/download"> Bitcoin Core </a> in binary format, decoding is done to specify fields for handling transactions between users. Those fiels are:</br> 
